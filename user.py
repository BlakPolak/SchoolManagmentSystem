        ...
        for submission_ in organisation.submissions_list:
            if submission_.student.name == self.name and submission_.student.surname == self.surname:
                if submission_.grade:
                    my_submissions_list.append([submission_.assignment.name, submission_.student.name,
                                               submission_.student.surname, submission_.grade])
        ui.Ui.print_table(my_submissions_list, ["Assignment", "Student name", "Student surname", "Student grade"])
